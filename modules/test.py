...
class NexxApp:
    def __init__(self, master=None):
        ...
        self.img_last = tk.PhotoImage(file='last.png')
        self.label1.configure(image=self.img_last, text='label1')
        self.label1.place(anchor='nw', relx='0.25', rely='0.4', x='0', y='0')
        self.label2 = tk.Label(self.frame2)
        self.label2.configure(background='#f04324', font='{Avero} 18 {italic}', text='ADD DETAILS ')
        self.label2.place(anchor='nw', relx='0.23', rely='0.1', x='0', y='0')
        self.frame2.configure(background='#f04324', height='500', width='300')
        self.frame2.place(anchor='nw', x='0', y='0')
        self.back_button_add = tk.Button(self.frame1)
        self.img_back = tk.PhotoImage(file='back.png')
        ...
        self.back_button_add.configure(highlightthickness='0', image=self.img_back, justify='left', text='button4')
